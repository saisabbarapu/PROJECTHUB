...
const ProjectCard = React.memo(({ project }) => {
  ...
  const imageUrl = useMemo(() => {
    // Use database-stored image if available, otherwise fall back to URL
  ...
  const pdfUrl = useMemo(() => {
    // Use database-stored PDF if available, otherwise fall back to URL
    if (project.pdfData) {
      // Create data URL directly from base64 data
        ...
        <div className={styles.popupOverlay} onClick={handleClosePopup}>
          <div className={styles.popupContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.popupLinks}>
              ...
              {pdfUrl ? (
                <a href={pdfUrl} target="_blank" rel="noreferrer" className={styles.link} onClick={handleLinkClick}>View PDF</a>
              ) : (
